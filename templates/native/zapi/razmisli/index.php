...
<body>
    <div class="main-container flex relative">
        <header class="native-hero episode-overlay full flex relative center">
            ...
            <a href="https://razmisli.net/" target="_blank" class="full center-text disclaimer italic">Kampanju Razmisli pokrenula je Zagrebačka pivovara 2008. godine s ciljem edukacije javnosti o odgovornom konzumiranju alkohola.</a>
            <div class="flex hero-left center">
                ...
                <nav class="full flex">
                    ...
                    <a class="full flex" href="#pozovi-nas">Podjeli svoju priču</a>
                </nav>
            </div>
            ...
            <div class="desktop-only arrow-indicator center">
                <div></div>
            </div>
        </header>
        <section class="full episode relative" id="razmisli">
            <div class="full flex normal-page-padding">
                ...
                <div class="full flex sad-stat" data-aos="fade-left" data-aos-delay="1000">
                    <p class="full bold">1526</p>
                    <p class="full"> prometnih nesreća s nastradalim osobama</p>
                </div>
                <div class="full flex sad-stat" data-aos="fade-left" data-aos-delay="2000">
                    <p class="full bold">2057</p>
                    <p class="full"> ljudi zadobilo je tjelesne ozljede</p>
                </div>
                <div class="full flex sad-stat" data-aos="fade-left" data-aos-delay="3000">
                    <p class="full bold">51</p>
                    <p class="full"> osoba smrtno je stradala</p>
                </div>
            </div>
        </section>
        <section class="full episode relative" id="video">
            <div class="full flex normal-page-padding">
                ...
                <p class="full shoo-bottom" data-aos="fade-right" data-aos-delay="250">Ambasadori kampanje s nama su podijelili svoja iskustva.</p>
        ...
        <section class="full episode relative" id="procitajte-vise">
            <div class="full flex">
                <h2 class="full relative episode-title" data-aos="fade-left">Moja priča</h2>
                <p class="full pad-left" data-aos="fade-right" data-aos-delay="250">Ovih 10 ljudi prisjetilo se trenutaka koji su im promijenili život.</p>
            ...
            <div class="full flex">
                ...
                <div class="full sugovornici extra-content flex stretch">
                    <div class="third flex-responsive flex">
                        <div class="full center utjecaj-indicator">
                            <div></div>
                        </div>
        ...
        <section class="full episode flex relative stretch" id="pozovi-nas">
            <div class="half flex-responsive flex relative form-parent">
                <h2 class="full episode-title no-pad" data-aos="fade-left">Podijeli svoju priču</h2>

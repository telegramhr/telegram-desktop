<div class="w-full overflow-hidden px-4 mt-[-295px] lg:mt-[-312px] relative z-20">
    <div class="max-w-[85%] mx-auto flex flex-col">
        ...
        <div class="flex flex-col lg:flex-row bg-primary p-7 lg:p-3 items-center gap-6 lg:gap-18 ">
            <div class="relative">
                ...
                <div class="absolute top-[6px] left-1 lg:top-auto lg:bottom-0 flex flex-col">
                    <p class="text-primary font-crimson italic text-[12px] lg:text-[35px] leading-3 lg:leading-7">running <span class="font-bold text-[8px] lg:text-[24px] font-akshar">/ out of time</span></p>
                    <p class="text-primary font-crimson italic text-[12px] lg:text-[35px] leading-3 lg:leading-7">running </p>
                    <p class="text-primary font-crimson italic text-[12px] lg:text-[35px] leading-3 lg:leading-7">running <span class="font-bold text-[8px] lg:text-[24px] font-akshar">/ out of time</span></p>
                    <p class="text-primary font-crimson italic text-[12px] lg:text-[35px] leading-3 lg:leading-7">running </p>
                    <p class="text-primary font-crimson italic text-[12px] lg:text-[35px] leading-3 lg:leading-7">running <span class="font-bold text-[8px] lg:text-[24px] font-akshar">/ out of time</span></p>

...
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
 ...
 <link rel="stylesheet" href="https://use.typekit.net/jld5jyc.css">
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Darker+Grotesque:wght@400;500&display=swap" rel="stylesheet">
  ...
  <body>
      ...
      <div class="row align-items-center">
	   ...
	   <div class="row py-md-5" id="naslovnica">
	      <div class="col-md-7 mt-4 mt-md-0 fadeInLeft animated" data-wow-duration="2s" style="visibility: visible;-webkit-animation-duration: 2s; -moz-animation-duration: 2s; animation-duration: 2s;">
			...
			<span class="mobile text-center text-uppercase d-block mb-5">ona je uvijek u modi</span>
			<div class="banner-text my-4 my-md-5">
			 <p class="mb-3">Otvaramo vrata zagrebačkih muzeja i nudimo potpuno novi pogled. Neka kultura ostane u modi. Nosi ju i ti.</p>
			 <p>Zaviri u zagrebačke muzeje, podrži projekt i osvoji nagrade.</p>
			 </div>
	...
	<section class="third-section pt-5">
	  <div class="container-fluid">
	     <div class="row text-center d-block z-index-1">
	   ...
	   <div class="row bg-text heading-font font-light z-index-0">
	     		<nav class="marquee-block">
			
				
				
				<div class="marquee">
					<div class="marquee__inner" aria-hidden="true">
						<span class>#NOSIMKULTURU</span>
						<span>#NOSIMKULTURU</span>
						<span>#NOSIMKULTURU</span>
						<span>#NOSIMKULTURU</span>
					</div>
				</div>
		</nav>
<nav class="marquee-block2">		
					<div class="marquee2">
					<div class="marquee__inner" aria-hidden="true">
						<span>#NOSIMKULTURU</span>
						<span>#NOSIMKULTURU</span>
	...
	<section class="fourth-section pt-4 py-md-5" data-wow-duration="2s" id="vise" >
	  <div class="container">
	    
		  <div class="row py-md-5">
		   <p class="text-center w-100 pb-3 text-uppercase rock-font">Saznaj više o muzejima<br> i osvoji nagrade</p><br>
  ...
  <!--js script-->
	...
	<script src="<?php echo $native_path ?>/asset/js/slick.js"></script>

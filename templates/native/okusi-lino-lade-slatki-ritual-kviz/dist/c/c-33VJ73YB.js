import { N as w, U as v } from "https://st-p.rmcdn1.net/734750ea/dist/c/c-LO5P4M26.js";
import { D as U, a as d, r as h } from "https://st-p.rmcdn1.net/734750ea/dist/c/c-5MDQQ6CW.js";
import { a as p, b as C } from "https://st-p.rmcdn1.net/734750ea/dist/c/c-FPDSIPVG.js";
import { a as R } from "https://st-p.rmcdn1.net/734750ea/dist/c/c-OEP4NC2V.js";
...
function b(t, e, n = {}) {
    ...
    let o = e.emptyTitle ? "" : e.title,
        ...
        r = "",
        l = "";
    n.customDomain ? n.forProject ? r = o || "Project" : r = (o ? o + " \u2014 " : "") + (i || "Page " + t.num) : (n.forProject || (r = (i ? "\u2018" + i + "\u2019" : "Page " + t.num) + " from "), r += r.length ? `\u2018${o||"Koji okus Lino Lade najviše odgovara baš tebi? Riješi kviz i saznaj!"}\u2019` : o || "Project", n.forProject && e.description && (r += " | Readymag")), n.forProject ? l = P(e.pages.find($ => $.num === 1)) : l = P(t);
    let s = "";
    return n.customDomain ? n.forProject ? o ? s = f({ prefix: "", val: o, suffix: "" }) : s = "Project" : !o && !i ? s = "Page " + t.num : !o && i ? s = f({ prefix: "", val: i, suffix: "" }) : o && !i ? s = f({ prefix: "", val: o, suffix: " \u2014 Page " + t.num }) : o && i && (s = f({ prefix: "", val: o, suffix: " \u2014 " + i, minLength: 20 }), s.length > m && (s = i, s.length > m && (s = f({ prefix: "", val: i, suffix: "" })))) : n.forProject ? o ? s = f({ val: o }) : s = "Koji okus Lino Lade najviše odgovara baš tebi? Riješi kviz i saznaj!" : !o && !i ? s = `Page ${t.num}` : !o && i ? s = f({ val: i }) : o && !i ? s = f({ prefix: `Page ${t.num} from `, val: `\u2018${o}\u2019` }) : o && i && (s = f({ prefix: `\u2018${i}\u2019 from `, val: `\u2018${o}\u2019`, minLength: 20 }), s.length > m && (s = i, s.length > m && (s = f({ val: i })))), { image: l, title: r || "", description: c || "", tweet: s }
}
...
function x(t, e, n = {}) {
    ...
    let o = e.emptyTitle ? "" : e.title,
        i = "",
        c = "";
    return n.customDomain ? t && t.num > 1 ? i = (o ? o + " \u2014 " : "") + (t.title || "Page " + t.num) : (i = o || "Koji okus Lino Lade najviše odgovara baš tebi? Riješi kviz i saznaj!", c = e.description || "") : (t && t.num > 1 ? i = (t.title ? "\u2018" + t.title + "\u2019" : "Page " + t.num) + " from " : c = e.description || j, i = o || "Koji okus Lino Lade najviše odgovara baš tebi? Riješi kviz i saznaj!"), { title: i || "", description: c || "", keywords: "" }
}

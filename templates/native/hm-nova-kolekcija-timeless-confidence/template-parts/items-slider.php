<div data-aos="fade-up" data-aos-duration="2000" data-aos-delay="250" class="w-full py-20 px-[34px] overflow-hidden relative">
    <div class="flex animate-ticker whitespace-nowrap">
        ...
        <div class=" h-[292px] md:h-[512px] aspect-[3/4]">
            <picture>
                ...
                <img class="w-full h-full object-containt" src="<?php echo $native_path; ?>/assets/clothing/02.webp" alt="Kratka crna suknja">
            </picture>
        </div>
        <div class=" h-[292px] md:h-[512px] aspect-[3/4]">
            <picture>
                ...
                <img class="w-full h-full object-containt" src="<?php echo $native_path; ?>/assets/clothing/03.webp" alt="Čipkasta pidžama ">
            </picture>
        </div>
        <div class=" h-[292px] md:h-[512px] aspect-[3/4]">
            <picture>
                ...
                <img class="w-full h-full object-containt" src="<?php echo $native_path; ?>/assets/clothing/04.webp" alt="Duga ženska bež haljina">
            </picture>
        </div>
        <div class="px-6 h-[292px] md:h-[512px] aspect-[3/4]">
            <picture>
        ...
        <div class=" h-[292px] md:h-[512px] aspect-[3/4]">
            <picture>
                <source srcset="<?php echo $native_path; ?>/assets/clothing/02.webp" type="image/webp">
                <source srcset="<?php echo $native_path; ?>/assets/clothing/02.png" type="image/jpeg">
                <img class="w-full h-full object-containt" src="<?php echo $native_path; ?>/assets/clothing/02.webp" alt="">
            </picture>
        </div>
        <div class=" h-[292px] md:h-[512px] aspect-[3/4]">
            <picture>
                <source srcset="<?php echo $native_path; ?>/assets/clothing/03.webp" type="image/webp">
                <source srcset="<?php echo $native_path; ?>/assets/clothing/03.png" type="image/jpeg">
                <img class="w-full h-full object-containt" src="<?php echo $native_path; ?>/assets/clothing/03.webp" alt="">
            </picture>
        </div>
        <div class="h-[292px] md:h-[512px] aspect-[3/4]">
            <picture>
                <source srcset="<?php echo $native_path; ?>/assets/clothing/04.webp" type="image/webp">
                <source srcset="<?php echo $native_path; ?>/assets/clothing/04.png" type="image/jpeg">
                <img class="w-full h-full object-containt" src="<?php echo $native_path; ?>/assets/clothing/04.webp" alt="">
            </picture>
        </div>
        <div class="px-6 h-[292px] md:h-[512px] aspect-[3/4]">
            <picture>
                <source srcset="<?php echo $native_path; ?>/assets/clothing/05.webp" type="image/webp">
                <source srcset="<?php echo $native_path; ?>/assets/clothing/05.png" type="image/jpeg">
                <img class="w-full h-full object-containt" src="<?php echo $native_path; ?>/assets/clothing/05.webp" alt="">
            </picture>
        </div>
    </div>
</div>

...
themetechmount_sticky()});jQuery(document).ready(function(){jQuery(".widget_nav_menu li a").each(function(){if(!jQuery(this).attr('href')){jQuery(this).closest("li").addClass("empty_link")}});jQuery('.themetechmount-coverbox-w .ttm-coverbox-column-w').each(function(){jQuery(this).hover(function(){jQuery(this).parents('.themetechmount-coverbox-w').find('.ttm-coverbox-column-w').removeClass('tm-active-cvbox');jQuery(this).addClass('tm-active-cvbox')})})})
...
<html lang="hr">
<?php
    $native_path = 'http://staging.telegram.hr/wp-content/themes/telegram-desktop/templates/native/erste/tgneue/';
?>
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="<?php echo $native_path ?>style.css?ver=3.4" type="text/css" />
        ...
        <header class="full flex relative">
            ...
            <div class="full hero-element center relative">
                <video preload="auto" autoplay="" muted="">
                    <source src="<?php echo $native_path; ?>img/tg_header_test.mp4" type="video/mp4">
                </video>
        ...
        <section class="full flex">
            ...
            <div class="full quotes center wrap">
                <h2 class="full section-title center-text">O nama pričaju...</h2>
                    <div class="third flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/sprajc.png" alt="Zoran Šprajc" />
                    ...
                    <div class="third flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/natasa-janjic.png" alt="Nataša Janjić, glumica" />
                    ...
                    <div class="third flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/mavric.png" alt="Dražen Mavrić, predsjednik Uprave Nove TV" />
                    ...
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/maruska-vizek.png" alt="Maruška Vižek" />
                    ...
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/luka-abrus.png" alt="Luka Abrus" />
            ...
            <a href="https://www.erstebank.hr/hr/george" class="full flex george hide" target="_blank">
                <h3 class="full center-text powered-by">Powered by</h3>
                <img src="<?php echo $native_path; ?>img/george_square.png" aria-hidden="true">
            </a>
            <div class="full quotes center wrap">
                <h2 class="full section-title center-text">O nama pričaju...</h2>
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/grlic1-1.png" alt="Rajko Grlić" />
                    ...
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/hrvoje-balen.png" alt="Hrvoje Balen, suosnivač Algebre" />
                    ...
                    <div class="fourth flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/bruketa.png" alt="Davor Bruketa, dizajner i kreativni direktor" />
                    ...
                    <div class="fourth flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/sakota.png" alt="Tvrtko Šakota, chef" />
                    ...
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/trupcevic.png" alt="Boris Trupčević, CEO 24 sata uskoro globalni CEO Forea" />
            ...
            <div class="full quotes center wrap">
                <h2 class="full section-title center-text">O nama pričaju...</h2>
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/vukovic-vuk.png" alt="Vuk Vuković, ekonomist" />
                    ...
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/janko-popovic-volaric.png" alt="Janko Popović Volarić, glumac" />
                    ...
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/medak.png" alt="Marin Medak, ugostitelj" />
                    ...
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/daniel-ackermann.png" alt="Daniel Ackermann, suosnivač agencije Degordian" />
            ...
            <div class="full quotes center wrap">
                <h2 class="full section-title center-text">O nama pričaju...</h2>
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/sonje-velimir.png" alt="Velimir Šonje, ekonomist" />
                    ...
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/marasovic.png" alt="Nevio Marasović, filmski redatelj" />
                    ...
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/hrvoje-kresic.png" alt="Hrvoje Krešić, novinar N1 televizije" />
                    ...
                    <div class="half flex-responsive pad-me">
                        <div class="quote relative">
                            <div class="quotation-marks">„</div>
                            <img class="quote-author-image" src="<?php echo $native_path ?>img/tea-zakula.png" alt="Tea Žakula, znanstvenica" />

...
<body>
<img src="https://track.adform.net/adfserve/?bn=76987247;1x1inv=1;srctype=3;ord=[timestamp]" border="0" width="1" height="1"/>
        ...
        <article class="full flex relative" id="ivanaandreja">
            ...
            <details class = "full">
                ...
                <div class="container column-full-pad text-container flex relative">
                    ...
                    <p>„Bilo je to kada su nas izdavači iz Litve odlučili posjetiti, konkretno Nordcurrent Labs. Bilo nas je malo strah tih sastanaka s našim startupima jer su im to bili prvi poslovni susreti takve vrste. Međutim, imati velike oznake A1 na zidovima pokazalo je izdavačima da smo ozbiljna zajednica koju prepoznaje i podržava globalna kompanija. To im je ulilo tu sigurnost da su došli na pravo mjesto“, kaže Ivana.</p>

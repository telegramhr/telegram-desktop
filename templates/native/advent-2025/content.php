<main class="w-full ">
    ...
    <?php partial('stations', [
        ...
        'polaroids' => [
            ...
            ['image' => 'https://images.telegram.hr/FCyHzKcqWcE3v71LD9fhCi_R64QyfZvWZALBIsWvB0k/preset:single1/aHR0cHM6Ly93d3cudGVsZWdyYW0uaHIvd3AtY29udGVudC91cGxvYWRzLzIwMjUvMTIvcml2YS0xLmpwZw.webp', 'text' => 'Tradicija i novi adventski sjaj: ove zime advent u Splitu vraća se svojoj najljepšoj ulozi', 'link' => 'https://www.telegram.hr/partneri/tradicija-i-novi-adventski-sjaj/?utm_medium=Internal&utm_source=Telegram.hr&utm_campaign=Partneri'],
            ['text' => 'Prosinac u ovom gradu ima poseban ritam. Doživite sunčani Advent uz more', 'image' => 'https://images.telegram.hr/eW4ZWmpitKql_peHwSHm81w17M8WS5n42Z8A4920pWU/preset:single1/aHR0cHM6Ly93d3cudGVsZWdyYW0uaHIvd3AtY29udGVudC91cGxvYWRzLzIwMjUvMTIvc3ZlY2Fub3N0LXBhbGplbmphLXBydmUtYWR2ZW50c2tlLXN2aWplY2UuanBn.webp', 'link' => 'https://www.telegram.hr/partneri/adventski-ritam-splita/?utm_medium=Internal&utm_source=Telegram.hr&utm_campaign=Partneri'],
            ['text' => 'Na kultnoj adventskoj lokaciji očekuju vas plesnjaci, sjajni koncerti i čarobne kulise. Evo što ne smijete propustiti', 'image' => 'https://images.telegram.hr/4OHkQFtSDE94X4qkrQ5_qWS0wWP78SBSMBOFV-xlb84/preset:single2/aHR0cHM6Ly93d3cudGVsZWdyYW0uaHIvd3AtY29udGVudC91cGxvYWRzLzIwMjUvMTIvZHNjMDczMjEtMS5qcGc.webp', 'link' => 'https://www.telegram.hr/partneri/na-kultnoj-adventskoj-lokaciji-ocekuju-vas-plesnjaci-sjajni-koncerti-i-carobne-kulise-evo-sto-ne-smijete-propustiti/'],
            ['text' => 'Od umjetničkih izložbi do plesa na balu: ako tražite inspiraciju, evo ideja kako ispuniti blagdanske dane', 'image' => 'https://images.telegram.hr/WSKrqgWSm6A-qaUcaKLaFiwCvbw2OtW50xywMhaiMdQ/preset:single2/aHR0cHM6Ly93d3cudGVsZWdyYW0uaHIvd3AtY29udGVudC91cGxvYWRzLzIwMjUvMTIvdGctbmFzbG92bmEtMjAyNS0xMi0xOC01LmpwZw.webp', 'link' => 'https://www.telegram.hr/partneri/od-umjetnickih-izlozbi-do-plesa-na-balu-ako-trazite-inspiraciju-evo-ideja-kako-ispuniti-blagdanske-dane/'],
            ['text' => 'Ovaj hrvatski grad proglašen je destinacijom s najšarmantnijim božićnim sajmom na svijetu. Imamo detalje', 'image' => 'https://images.telegram.hr/GmfViXQceyvtspuNH0IqdjipvHQTi6ksccrNDD80FMI/preset:single2/aHR0cHM6Ly93d3cudGVsZWdyYW0uaHIvd3AtY29udGVudC91cGxvYWRzLzIwMjUvMTIvbTI1LTAwNS0wMDAxNi5qcGc.webp', 'link' => 'https://www.telegram.hr/partneri/ovaj-hrvatski-grad-proglasen-je-destinacijom-s-najsarmantnijim-bozicnim-sajmom-na-svijetu-imamo-detalje/'],
        ],
    ]); ?>
    <?php partial('stations', [
        'native_path' => $native_path,

 ...
 <div class="w-full px-4 overflow-hidden flex flex-col gap-[100px] lg:gap-[215px] bg-[#F2E7DC] relative ">
     ...
     <div class="pb-[148px] md:pb-50 px-4 relative">
         <img class="absolute max-w-[194px] md:max-w-none right-[-70px] md:right-[-100px] bottom-0" src="<?= $native_path ?>/assets/footer/christmastree.webp" alt="">
         <img class="absolute max-w-[194px] md:max-w-none left-[-70px] md:left-[-100px] bottom-0 transform -scale-x-100" src="<?= $native_path ?>/assets/footer/christmastree.webp" alt="">

         <div class="min-w-[185px] max-w-[80%] md:max-w-[640px]  mx-auto flex flex-col gap-4 lg:gap-[52px]">
        ...
        <div class="w-fit flex mx-auto mt-10 flex-row gap-5 lg:gap-8">
            <img src="<?= $native_path; ?>/assets/hero/zrinjevacBlack.png" alt="Zrinjevac logo"
                class="h-[40px] md:h-[70px] object-contain">
            <img src="<?= $native_path; ?>/assets/hero/splitBlack.png" alt="Split logo"
                class="h-[40px] md:h-[70px] object-contain">
            <img src="<?= $native_path; ?>/assets/footer/rovinj.png" alt="Rovinj advent logo"
                class="h-[40px] md:h-[70px] object-contain">
        </div>
     </div>
 </div>
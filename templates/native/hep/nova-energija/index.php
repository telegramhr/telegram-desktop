...
<html lang="en">
<?php
		$native_path = 'https://www.telegram.hr/wp-content/themes/telegram2-desktop/templates/native/telegram/hep';
	?>
  <head>
    <meta charset="utf-8">
  ...
  <section class="top-banner">
    <div class="container pt-md-5 pt-0">
	   ...
	   <span class="text-white d-none d-lg-block position-relative">Napomena: ovo je animirana <br/>vektorska grafika</span>
	   </div> -->
  ...
  <section class="info-section">
    <div class="container text-center pb-4">
	  ...
	  <div class="row justify-content-center ">
		...
		<p class="pb-4">Ravnateljica Hrvatskog poslovnog savjeta za održivi razvoj Mirjana Matešić objašnjava zašto je važna koordinirana tranzicija na održivost...</p> 
		<a href="https://www.telegram.hr/partneri/strucnjakinja-o-prelasku-na-odrzivo-poslovanje-tvrtke-koje-se-ne-ukljuce-sada-izgubit-ce-bitku-na-trzistu/" target="_blank" class="btn">Pročitajte</a>
		</div>
	  </div>
	</div>
	<div class="info-banner info-banner-one mt-5 position-relative">
	  ...
	  <img src="asset/images/banner-small-2.png" class="img-info-banner d-block d-sm-none"/> -->
	</div>
  </section>
  ...
  <section class="info-section">
    <div class="container text-center pb-4">
	  ...
	  <div class="row justify-content-center ">
	    <div class="col-md-7 ms-auto">
		<p class="pb-4">Stanley Whittingham koncipirao je litij-ionske baterije još krajem 70-ih godina prošlog stoljeća, za što je dobio Nobelovu nagradu...</p> 
		<a href="https://www.telegram.hr/partneri/kako-ce-baterije-buducnosti-utjecati-na-trziste-elektricnih-automobila-razgovarali-smo-s-profesorom-s-fer-a/" target="_blank" class="btn">Pročitajte</a>
		</div>
	  </div>
	</div>
	<div class="info-banner info-banner-two mt-5 position-relative">
	 ...
	 <!--  <img src="asset/images/banner-3.png" class="img-info-banner d-none d-sm-block"/>
	  <img src="asset/images/banner-small-3.png" class="img-info-banner d-block d-sm-none"/> -->
	</div>
  </section>
  ...
  <section class="info-section">
    <div class="container text-center pb-4">
	  ...
	  <div class="row justify-content-center ">
	    <div class="col-md-7 ms-auto">        		
		<p class="pb-4">Kako bi se osigurala energetska učinkovitost, u Hrvatskoj se sve više koriste IoT tehnologije, a mijenja se i način na koji gradimo</p> 
		<a href="https://www.telegram.hr/partneri/istrazili-smo-kojim-projektima-hrvatski-gradovi-i-tvrtke-love-titulu-pametnih-i-odrzivih-ima-sjajnih-primjera/" target="_blank" class="btn">Pročitajte</a>
		</div>
	  </div>
	</div>
  ...
  <section class="info-section">
    <div class="container text-center pb-4">
	  ...
	  <div class="row justify-content-center ">
		...
		<p class="pb-4">Krajem desetljeća možemo očekivati tegljače, avione i brodove na čisti vodik ili ne elektrogorivo proizvedeno pomoću zelenog vodika...</p> 
		<a href="https://www.telegram.hr/partneri/na-korak-smo-od-buducnosti-koju-je-predvidio-jules-verne-o-vodiku-govore-nasa-dva-najveca-strucnjaka/" target="_blank" class="btn">Pročitajte</a>
		</div>
	  </div>
	</div>
	<div class="info-banner info-banner-three mt-5 position-relative">
	  ...
	  <img src="asset/images/banner-small-4.png" class="img-info-banner d-block d-sm-none"/> -->
	</div>
  </section>
  ...
  <section class="info-section">
    <div class="container text-center pb-4">
	  ...
	  <div class="row justify-content-center ">
	    <div class="col-md-8 ms-auto">
        <h2 class="py-4">Istraživanja pokazuju da studenti STEM-a očekuju najveće plaće. No jesu li takva očekivanja opravdana?</h2>		
		<p class="pb-4">Kako znanost i tehnologija postaju sve važnije komponente naših života, očekuje se kako će poslovi iz STEM-a (znanost, tehnologija...</p> 
		<a href="https://www.telegram.hr/partneri/istrazivanja-pokazuju-da-studenti-stem-a-ocekuju-najvece-place-no-jesu-li-takva-ocekivanja-opravdana/"  target="_blank" class="btn">Pročitajte</a>
		</div>
	  </div>
	</div>
	<div class="info-banner-four info-banner pt-5 position-relative">	   
	  <!-- <img src="asset/images/banner-5.png" class="img-info-banner d-none d-sm-block"/>
	  <img src="asset/images/banner-small-5.png" class="img-info-banner d-block d-sm-none"/> -->
	</div>
  </section>

        ...
        <div
            ...
            <div class='relative w-full md:max-w-[380px] aspect-[1.64] md:aspect-auto md:h-full'>
                <img class='w-full h-full object-cover'
                    src="https://images.telegram.hr/Gy-iDKRR1J23SOZOxoICkR-7ycSBfP0QSaMwRpKPins/preset:single2/aHR0cHM6Ly93d3cudGVsZWdyYW0uaHIvd3AtY29udGVudC91cGxvYWRzLzIwMjYvMDYvbWVzc2ktOC1lMTc4MjE2MjEzNzc0MS5qcGc.webp"
            ...
            <div class='py-7 md:py-15 px-5 md:px-13 flex flex-col gap-6 md:gap-7 justify-center md:justify-items-start'>
                <div
                    ...
                    <span
                        class='font-geist text-[22px] md:text-[44px] md:leading-[46px] leading-[26px] font-extrabold'>Lionel Messi</span>
                    <p class='font-inter text-[14px] md:text-[20px] md:leading-[30px]'>
                        <?php echo zp_team_label('Argentina'); ?></p>
                    <p

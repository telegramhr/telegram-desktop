...
<div id='player-of-the-day' class='w-full pt-10 pb-14 md:py-20 text-white'>
    <div class='max-w-[1307px] w-full mx-auto px-6 md:px-0 flex flex-col gap-8 '>
        <div class='flex flex-col gap-4 md:gap-[22px] max-w-[260px] mx-auto md:max-w-none text-center'>
            <h2 class='font-geist font-extrabold text-[24px] leading-7 md:text-[32px] md:leading-10 tracking-[-1%]'>Player of the day</h2>
            <p class='font-geist text-[16px] md:text-[18px]'>Posjeti naše društvene mreže i glasaj za najboljeg igrača dana</p>
        </div>
        <div class='max-w-[870px] md:h-[460px] bg-playerofday rounded-2xl w-full mx-auto flex flex-col md:flex-row overflow-hidden'>
            ...
            <div class='py-7 md:py-15 px-5 md:px-13 flex flex-col gap-6 md:gap-7 justify-center md:justify-items-start'>
                <div class='flex flex-col gap-3 md:gap-7 justify-center w-full max-w-[220px] md:max-w-none mx-auto md:mx-0 text-center md:text-left'>
                    <span class='font-geist font-bold text-[12px] md:text-[16px] px-11 md:px-3 py-[6px] bg-[#3A7D28] rounded-md w-fit inline-flex items-center gap-2 mx-auto md:mx-0'>
                        <svg width='14' height='14' viewBox='0 0 24 24' fill='#FFC107' xmlns='http://www.w3.org/2000/svg' aria-hidden='true'>

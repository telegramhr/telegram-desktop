    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
          <div class="kartica <?php echo date('d') < 3 ? 'skrivena' : '' ?>">
          ...
          <div class="karticaoff <?php echo date('d') > 1 ? 'skrivena' : '' ?>">
            <h2>02</h2>
          </div>
        </div>
        <div class="col-lg-2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
          <div class="kartica <?php echo date('d') < 4 ? 'skrivena' : '' ?>">
          ...
          <div class="karticaoff <?php echo date('d') > 2 ? 'skrivena' : '' ?>">
            <h2>03</h2>
          </div>
        </div>
        <div class="col-lg-2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
          <div class="kartica <?php echo date('d') < 5 ? 'skrivena' : '' ?>">
          ...
          <div class="karticaoff <?php echo date('d') > 3 ? 'skrivena' : '' ?>">
            <h2>04</h2>
          </div>
        </div>
        <div class="col-lg-2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
          <div class="kartica <?php echo date('d') < 6 ? 'skrivena' : '' ?>">
          ...
          <div class="karticaoff <?php echo date('d') > 4 ? 'skrivena' : '' ?>">
            <h2>05</h2>
          </div>
        </div>
        <div class="col-lg-2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
          <div class="kartica <?php echo date('d') < 7 ? 'skrivena' : '' ?>">
          ...
          <div class="karticaoff <?php echo date('d') > 5 ? 'skrivena' : '' ?>">
            <h2>06</h2>
          </div>
        </div>
        <div class="col-lg-2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
          <div class="kartica <?php echo date('d') < 8 ? 'skrivena' : '' ?>">
          ...
          <div class="karticaoff <?php echo date('d') > 6 ? 'skrivena' : '' ?>">
            <h2>07</h2>
          </div>
        </div>
        <div class="col-lg-2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.7s">
          <div class="kartica <?php echo date('d') < 9 ? 'skrivena' : '' ?>">
          ...
          <div class="karticaoff <?php echo date('d') > 7 ? 'skrivena' : '' ?>">
            <h2>08</h2>
          </div>
        </div>
        <div class="col-lg-2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
          <div class="kartica <?php echo date('d') < 10 ? 'skrivena' : '' ?>">
          ...
          <div class="karticaoff <?php echo date('d') > 8 ? 'skrivena' : '' ?>">
            <h2>09</h2>
          </div>
        </div>
        <div class="col-lg-2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.9s">
          <div class="kartica <?php echo date('d') < 11 ? 'skrivena' : '' ?>">

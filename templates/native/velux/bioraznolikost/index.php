    ...
    <section class="full native-content">
        <div class="text-container flex relative">
            ...
            <div class="full gallery relative">
                <div>
                    <img src="<?php echo $native_path ?>img/jadran/Sklat_pustanje_(6).JPG" aria-hidden="true">
            ...
            <h3 class="full center-text">Koliko je godina potrebno jednoj kompaniji da nadonkadi svoj ukupni CO2 footprint?</h3>
            ...
            <p>Lastovski inkubator trenutno je u fazi u kojoj traže tržište i kupce kako bi poslovne ideje doveli do stvarnih proizvoda ili usluga. Prva tvrtka koja je investirala u Plavi inkubator na našem najudaljenijem naseljenom otoku je VELUX.</p>

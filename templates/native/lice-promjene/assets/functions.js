...
jQuery(document).ready(function ($) {
    ...
    $('.answer').click(function () {
        ...
        if (active !== 10) {
            ...
            var rightnow_test = rightnow.toISOString();
            var response_object = { result: resultType, time: rightnow_test };

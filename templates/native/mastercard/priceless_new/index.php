...
<body>
    ...
    <div class="gray-background full flex">
        <section class="coming-soon-article container flex bottom-pad">
            <h4 class="full relative" data-aos="fade-left" data-aos-duration="500" data-aos-delay="250"><?php echo file_get_contents($directory . "img/clock.svg"); ?>Pročitaj uskoro! Priča stiže 08.11.</h4>

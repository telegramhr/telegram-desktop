    ...
    <div class="main-container flex relative">
        ...
        <header class="full center relative hero-photo mobile-only">
            <nav class="full center relative folder-nav">
                ...
                <a class = "absolute yellow-folder full" href="#beauty"><img src="<?php echo $native_path ?>assets/placeholders/dugi-zuti-mobile-2.png" alt="Back to Beauty" data-aos="fade-left" data-aos-delay="1000"></a>
        ...
        <section class="full center relative notebook-bg">
            <div class="half center wrap relative desktop-only">
                <div class="full center">
                    <img class = "third column-full-pad absolute kava-img" src="<?php echo $native_path ?>assets/placeholders/kava.png" alt="kava" data-aos="fade-right" data-aos-delay="250"/>
                </div>
                <div class="full">
                    <img class = "left-margin thirty shoo-bottom" src="<?php echo $native_path ?>assets/placeholders/makeup-1.png" alt="makeup" data-aos="fade-left" data-aos-delay="250"/>
                </div>
                <div class="full center">
                    <img class = "thirty absolute yoga-img" src="<?php echo $native_path ?>assets/placeholders/yoga(2).png" alt="yoga mat and weight" data-aos="fade-right" data-aos-delay="250"/>
                </div>
            </div>
            ...
            <div class="container flex relative">
                ...
                <div class="full flex relative">
                    <div class="full flex relative desktop-only negative-margin" data-aos="fade-down" data-aos-delay="250">
                        <img src= "<?php echo $native_path ?>assets/placeholders/final-pilates-naslov.png" alt="pilates bag" class="full animate desktop-only" data-aos="fade-in" data-aos-delay="250">
        ...
        <section class="full flex relative" id = "fashion">
            <img src="<?php echo $native_path ?>assets/placeholders/pozadina-fashion.png" alt="" class="full animate absolute desktop-only folder-bg blue-bg">
            <img src="<?php echo $native_path ?>assets/placeholders/duga-roza.png" alt="" class="full animate absolute mobile-only blue-bg">
            <div class="container flex relative">
            <div class="full center relative" data-aos="fade-left" data-aos-delay="250">
        ...
        <section class="full flex relative shoo-top yellow-bg" id = "beauty">
            ...
            <div class="container flex relative">
                ...
                <div class="chat-bubble bubble-left" data-aos="fade-right" data-aos-delay="250">
                ...
                <a href="https://www.telegram.hr/super1/beauty/razdjeljak-na-stranu-valovi-bob-i-druge-trendi-frizure-koje-ce-obiljeziti-jesensku-sezonu/" target = "_blank" class="half flex relative flex-responsive">
                    ...
                    <a href="https://www.telegram.hr/super1/beauty/oribe-mirror-rinse-glass-hair-tretman-sjajna-kosa/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-plavi.png" alt="" class="full animate column-full-pad">
                        <div class="half center folder-text box">
                            <p class="full">Glass hair Kako vratiti sjaj kosi nakon ljeta? Ovaj proizvod obećava stakleno sjajnu kosu u samo nekoliko minuta </p>
                        </div>
                    ...
                    <a href="https://www.telegram.hr/super1/beauty/crni-nokti-ideje/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-plavi.png" alt="" class="full animate column-full-pad">
                        <div class="full center folder-text box">
                            <p class="full">Nail inspo Crni nokti su elegantni i odvažni klasik među manikurama. Evo kako ih nositi </p>
                        </div>
                    ...
                    <a href="https://www.telegram.hr/super1/beauty/bob-frizure-tanka-rijetka-kosa/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-plavi.png" alt="" class="full animate column-full-pad">
                        <div class="half center folder-text box">
                            <p class="full">Hair inspo Najbolja frizure za tanku i rijetku kosu? Bob u četiri verzije koje stvaraju volumen </p>
                        </div>
                    ...
                    <a href="https://www.telegram.hr/super1/shopping-vodic/najbolji-korektor-za-podocnjake/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-plavi.png" alt="" class="full animate column-full-pad">
                        <div class="half center folder-text box">
        ...
        <section class="full flex relative shoo-top blue-bg" id = "lifestyle">
            <img src="<?php echo $native_path ?>assets/placeholders/life-pozadina.png" alt="" class="full animate absolute desktop-only folder-bg yellow-bg">
            ...
            <div class="full center relative">
                <img src="<?php echo $native_path ?>assets/placeholders/life-circle.png" alt="models" class="half animate shoo-top-bottom rotate-fade-in desktop-only">
                <img src="<?php echo $native_path ?>assets/placeholders/life-circle-mobile.png" alt="models" class="full animate rotate-fade-in mobile-only life-circle">
            </div>
                <div class="full flex relative negative-margin">
                    ...
                    <a href="https://www.telegram.hr/super1/life/pinterest-trend-repost-jesen-2025/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-zuti.png" alt="zuti folder s clankom" class="full animate column-full-pad">
                        <div class="half center folder-text box">
                    ...
                    <a href="https://www.telegram.hr/super1/life/undo-projekt-marta-francekovic-antonija-bacic-intervju/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-zuti.png" alt="zuti folder s clankom" class="full animate column-full-pad">
                        <div class="full center folder-text box">
                    ...
                    <a href="https://www.telegram.hr/super1/life/5-knjiga-koje-citamo-nakon-godisnjih/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-zuti.png" alt="zuti folder s clankom" class="full animate column-full-pad">
                        <div class="half center folder-text box">
                    ...
                    <a href="https://www.telegram.hr/super1/life/second-degree-dinner-druzenja/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-zuti.png" alt="zuti folder s clankom" class="full animate column-full-pad">
                        <div class="half center folder-text box">
                    ...
                    <a href="https://www.telegram.hr/super1/life/najljepsi-sukulenti-jednostavne-biljke-zeleni-dom/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-zuti.png" alt="zuti folder s clankom" class="full animate column-full-pad">
                        <div class="half center folder-text box">
        ...
        <section class="full flex relative shoo-top brown-bg" id = "design">
            ...
            <div class="full center relative" data-aos="fade-down" data-aos-delay="250">
                ...
                <div class="full flex relative negative-margin">
                    ...
                    <a href="https://www.telegram.hr/super1/design/back-to-school-uredenje-kucnog-ureda/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-bijeli.png" alt="plavi folder s clankom" class="full animate column-full-pad">
                        <div class="half center folder-text box">
                    ...
                    <a href="https://www.telegram.hr/super1/design/neuroestetsko-uredenje-interijera-sto-je-i-kako-urediti/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-bijeli.png" alt="plavi folder s clankom" class="full animate column-full-pad">
                        <div class="full center folder-text box">
                    ...
                    <a href="https://www.telegram.hr/super1/design/cloffice-uredenje-ideje/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-bijeli.png" alt="plavi folder s clankom" class="full animate column-full-pad">
                        <div class="half center folder-text box">
                    ...
                    <a href="https://www.telegram.hr/super1/design/nijanse-koje-cemo-vidati-u-interijeru-na-jesen/" target = "_blank" class="half flex relative flex-responsive">
                        <img src="<?php echo $native_path ?>assets/placeholders/mali-bijeli.png" alt="plavi folder s clankom" class="full animate column-full-pad">
                        <div class="half center folder-text box">
        ...
        <section class="full flex relative shoo-top"id = "power">
            <img src="<?php echo $native_path ?>assets/placeholders/power-pozadina.png" alt="" class="full animate absolute desktop-only folder-bg brown-bg">

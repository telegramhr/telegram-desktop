...
function telegram_enqueue_styles() {
    wp_enqueue_style('telegram-style', get_stylesheet_uri(), array('font-awesome', 'lora', 'pt-sans', 'slick', 'slick-theme'), '94870.08');
...
function telegram_scripts() {
    ...
    wp_enqueue_script('telegram-script', get_templates_directory_uri() . '/assets/js/functions.js', array('jquery', 'slick', 'colour-brightness', 'sticky-kit'), '94870.21', true);

            ...
            <div class="izbori-widget">
                ...
                <div class="full flex swing-states">
                    ...
                    <div class="third flex-responsive">
                        <svg xmlns="http://www.w3.org/2000/svg" width="959" height="593" class="map-usa" viewBox="0 0 930 600">
                            <title>Karta država SAD-a</title>
                            <!-- Attribution: Wikimedia Commons, https://commons.wikimedia.org/wiki/File:Blank_US_Map_(states_only).svg -->
                            <g class="state">

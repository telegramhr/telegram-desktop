...
<?php
    ...
    function podcast_platforms_shortcode($atts) {
        ...
        <div class="podcasts-wrapper-shortcode">
            <div class="wrapper">
                <a href="<?php echo esc_url($atts['youtube']); ?>" target="_blank" rel="noopener noreferrer"
                    class="podcast-box youtube">
                ...
                <a href="<?php echo esc_url($atts['spotify']); ?>" target="_blank" rel="noopener noreferrer"
                    class="podcast-box spotify">
                ...
                <a href="<?php echo esc_url($atts['apple']); ?>" target="_blank" rel="noopener noreferrer"
                    class="podcast-box apple">
                ...
                <a href="<?php echo esc_url($atts['others']); ?>" target="_blank" rel="noopener noreferrer"
                    class="podcast-box random">

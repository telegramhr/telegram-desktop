...
function super1_unautop_4_img($content)
{
    ...
    $content = preg_replace_callback(
        '/(<figure class="wp-block-media-text.*?><img(.*?)><\/figure>)/s',
        function ($m) {
            if (count($m) < 2) {
                return $m[0];
            }
    ...
    $content = preg_replace_callback(
        '/(<figure class="wp-block-image.*?><img(.*?)><\/figure>)/s',
        function ($m) {
            $image_id = false;
            if (count($m) < 2) {
                return $m[0];
    ...
    $content = preg_replace_callback(
        '/(<div class="wp-block-image.*?><figure.*?><img(.*?)><\/figure><\/div>)/s',
        function ($m) {
            if (count($m) < 2) {
                return $m[0];
            }
...
add_action('init', function () {
    update_option(
        'advent_2025',
        'a:2:{s:20:"24.11. - 30.11.2025.";a:1:{i:0;a:5:{s:4:"date";s:24:"2025-11-24T23:00:00.000Z";s:4:"time";s:24:"1899-12-30T16:00:00.000Z";s:5:"title";s:4:"Test";s:8:"location";s:4:"test";s:8:"category";s:7:"Zalogaj";}}s:17:"1.12. - 7.12.2025";a:1:{i:0;a:5:{s:4:"date";s:24:"2025-11-24T23:00:00.000Z";s:4:"time";s:24:"1899-12-30T16:00:00.000Z";s:5:"title";s:4:"Test";s:8:"location";s:4:"test";s:8:"category";s:7:"Zalogaj";}}}'
    );
});
